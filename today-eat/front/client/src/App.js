...
function App() {
    ...
    const [rollingItems, setRollingItems] = useState({ drink: null, staple: null, dish: null });
    const [availableDishes, setAvailableDishes] = useState({ drink: [], staple: [], dish: [] });
    ...
    const SlotWindow = ({ type, item, isStopped }) => {
